...
class Args:
    ...
    def initialize(parser):
        # args for path
        parser.add_argument('--output_dir', default='./casrel/checkpoints/',
                            help='the output dir for model checkpoints')

        parser.add_argument('--bert_dir', default='../model_hub/bert-base-chinese/',
                            help='bert dir for uer')
        parser.add_argument('--data_dir', default='./casrel/data/cner/',
                            help='data dir for uer')
        parser.add_argument('--log_dir', default='./casrel/logs/',
