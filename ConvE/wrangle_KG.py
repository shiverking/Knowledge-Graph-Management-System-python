...
data_path = "/home/cjw/kg-reeval/data/"
base_path = '{1}/{0}/'.format(dataset_name, data_path)
...
write_training_graph(test_cases['train.txt'], train_graph['train.txt'], '{1}/{0}/e1rel_to_e2_train.json'.format(dataset_name, data_path))
write_evaluation_graph(test_cases['valid.txt'], label_graph, join('{1}/{0}/e1rel_to_e2_ranking_dev.json'.format(dataset_name, data_path)))
write_evaluation_graph(test_cases['test.txt'], label_graph, '{1}/{0}/e1rel_to_e2_ranking_test.json'.format(dataset_name, data_path))
write_training_graph(all_cases, label_graph, '{1}/{0}/e1rel_to_e2_full.json'.format(dataset_name, data_path))
